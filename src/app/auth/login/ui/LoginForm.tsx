...
export const LoginForm = ({ isVerified }: FormLoginProps) => {
  ...
  return (
    <>
      ...
      <p className="text-center text-red-500 mb-5 text-sm">{error}</p>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col">
        {errors.email || errors.password ? (
          ...
          userError && (
            <span className="text-red-500 my-2">
              <p>
                <i>
                  Usuario incorrecto. Verifica tus credenciales e inténtalo de
                  nuevo.
                </i>
              </p>
            </span>
        ...
        <Link
          ...
          className="text-sm text-slate-600 hover:text-slate-800 mb-5 text-right"
        >
