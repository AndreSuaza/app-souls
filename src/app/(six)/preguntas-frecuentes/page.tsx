...
export const metadata: Metadata = {
  ...
  description:
    "Encuentra aquí las respuestas oficiales a las dudas más comunes sobre reglas, mecánicas y efectos dentro de Souls In Xtinction. Una guía rápida y clara para que cada duelo se juegue de forma correcta y sin confusiones.",
  openGraph: {
    title: "Centro Oficial de Preguntas Frecuentes Souls In Xtinction TCG",
    description:
      "Encuentra aquí las respuestas oficiales a las dudas más comunes sobre reglas, mecánicas y efectos dentro de Souls In Xtinction. Una guía rápida y clara para que cada duelo se juegue de forma correcta y sin confusiones.",
