...
export const metadata: Metadata = {
  ...
  description:
    "Vive la emoción de la competencia y el crecimiento de la comunidad en los torneos oficiales de Souls In Xtinction.",
  openGraph: {
    title: "Forja tu Legión de Almas Torneo Souls In Xticition",
    description:
      "Vive la emoción de la competencia y el crecimiento de la comunidad en los torneos oficiales de Souls In Xtinction.",
    ...
    <>
      ...
      <article className="mx-4 lg:mx-40 grid md:grid-cols-3">
        <section className="md:col-span-2 my-10">
          <p>
            Este torneo está diseñado para fortalecer la comunidad invitando a
          ...
          <p className="mb-4">
            Dependiendo del número de nuevos jugadores que invites, recibirás
            sobres de recompensa:
          </p>
          <ul className="mb-6">
            <li className="ml-4">
              <b>1 </b>jugador nuevo → 1 sobre maestro.
            </li>
            <li className="ml-4">
              <b>3 </b>jugadores nuevos → 1 sobre maestro + 1 sobre de
              expansión.
            </li>
            <li className="ml-4">
              <b>5 </b>jugadores nuevos → 2 sobres maestros + 2 sobres de
              expansión + 1 sobre de circuito.
            </li>
            <li className="ml-4">
              <b>10 </b>jugadores nuevos → 3 sobres maestros + 3 sobres de
              expansión + 3 sobres de circuito.
            </li>
          </ul>
          <p className="mb-6 font-semibold">
            ¿Eres nuevo y quieres conocer Souls In Xtinction? Puedes inscribirte
            directamente y recibirás 1 sobre maestro solo por participar.
          </p>

          <div className="">
            <p className="mb-6">
              <strong>Recompensa especial:</strong> El jugador que traiga más
              nuevos jugadores recibirá una carta Escudos gemelos foil
          ...
          <ul className="mb-4">
            <li className="font-semibold">
              Un mazo de demostración para aprender a jugar.
            </li>
            <li className="font-semibold">
          ...
          <p className="mb-4">
            <strong>Nota:</strong> Hay 40 mazos de demostración disponibles por
            evento, así que llega temprano y asegura tu participación.
          </p>

          <p>
            <strong>
              ¡Forja tu legión y conviértete en parte del universo de Souls In
              Xtinction!
            </strong>
          </p>
        </section>
        ...
        <div className="bg-gray-200 px-6 py-4 rounded-xl mt-10">
          ...
          <div className="grid grid-cols-3">
            <div className="col-span-2 mt-2">
              ...
              <p className="">
                <span className="font-bold mr-1">Ciudad:</span> Bogotá, Colombia
              </p>
              <p className="">
                <span className="font-bold mr-1">Dirección:</span> Cl. 52 #24-18
              </p>
            </div>
          </div>
