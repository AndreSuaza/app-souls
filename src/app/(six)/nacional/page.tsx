...
export const metadata: Metadata = {
  ...
  description:
    "El Nacional de Souls In Xtinction reúne a los mejores jugadores del país en una batalla épica por la gloria. Estrategia, habilidad y pasión se enfrentan para definir al verdadero maestro de las almas.",
  openGraph: {
    title: "Torneo Nacional | Souls In Xtinction TCG",
    description:
      "El Nacional de Souls In Xtinction reúne a los mejores jugadores del país en una batalla épica por la gloria. Estrategia, habilidad y pasión se enfrentan para definir al verdadero maestro de las almas.",
