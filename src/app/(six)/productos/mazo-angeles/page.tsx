...
export const metadata: Metadata = {
  title: "Mazo Angeles - Amanecer Celestial | Souls In Xtinction TCG",
  description:
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://soulsinxtinction.com/product-pages/me2.webp",
        width: 500,
        height: 500,
...
export default async function getProductBySlug() {
  ...
  return (
    <>
      <section
        className={`bg-[url(/product-pages/me2bg.webp)] bg-cover bg-fixed w-full bg-left-top grid grid-cols-1 lg:grid-cols-2`}
      >
