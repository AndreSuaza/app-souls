...
export const metadata: Metadata = {
  ...
  description: 'La nueva expansión de Souls In Xtinction abre las puertas al pasado prohibido del alma. Entre sombras y ecos antiguos emergen los Vampiros, maestros de la corrupción y la eternidad, y los Isiras, guardianes de la esencia espiritual. Dos fuerzas opuestas unidas por un mismo destino: revelar los secretos que el tiempo intentó enterrar.',
  openGraph: {
...
export default async function getProductBySlug() {
  ...
  return (
    ...
    <>
    <section className={`bg-[url(/products/MOG.webp)] bg-cover bg-fixed w-full bg-left-top grid grid-cols-1 lg:grid-cols-2`}>
