...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://soulsinxtinction.com/product-pages/cataclismo/logo_cataclismo.webp",
        width: 500,
        height: 500,
...
export default async function Page() {
  ...
  return (
    <>
      ...
      <main className="relative isolate min-h-screen bg-[url('/product-pages/cataclismo/bg-cataclismo.webp')] bg-cover bg-center bg-fixed text-white before:absolute before:inset-0 before:z-0 before:bg-gradient-to-br before:from-[#17050a]/70 before:via-[#2a0b12]/70 before:to-[#120308]/70 before:content-['']">
