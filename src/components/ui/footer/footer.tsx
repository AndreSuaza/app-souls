        ...
        <div className="items-center mt-6">
          <Link href="/">
            <div className="flex flex-grow mb-10">
              ...
              />
              <span
                className={`${titleFont.className} antialiased font-bold my-auto ml-2`}
              >
                {" "}
          ...
          <p>
            ...
            escribirnos a: <b>sixtcginfo@gmail.com</b>. ¡Estamos aquí para
            ayudarte!
          </p>
        </div>
            ...
            <ul>
              <li className="mt-1">
                <Link
                  ...
                  target="_blank"
                  title="Instagram Souls in Xtincion"
                >
                  Instagram
                </Link>
              </li>
              <li className="mt-1">
                <Link
                  ...
                  target="_blank"
                  title="Youtube Souls in Xtincion"
                >
                  Youtube
                </Link>
              </li>
              <li className="mt-1">
                <Link
                  ...
                  target="_blank"
                  title="Facebook Souls in Xtincion"
                >
                  Facebook
                </Link>
              </li>
              <li className="mt-1">
                <Link
                  ...
                  target="_blank"
                  title="Tik Tok Souls in Xtincion"
                >
                  Tik Tok
                </Link>
              </li>
