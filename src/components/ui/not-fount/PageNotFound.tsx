  ...
  return (
      <div className="bg-[url(/portal.webp)] bg-black bg-center bg-no-repeat grid grid-cols-1 min-h-[600px]">
        <div className="w-full px-4 md:w-2/4 m-auto text-white text-center">
          ...
          <p className="text-xl mt-6">Parece que esta página ha caído en la extinción. Pero no te preocupes, aún puedes regresar y seguir explorando el mundo de Souls In Xtinction.</p>
          <Link href={"/"}>
