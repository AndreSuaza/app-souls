...
export const PlayerList = () => {
  ...
  return (
    <div className="flex-1 rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition-all dark:border-tournament-dark-border dark:bg-tournament-dark-surface">
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="lg:hidden">
          {showPlayers ? (
            <IoChevronUp
              className="p-1 w-8 h-8 rounded-md border border-slate-200 text-slate-600 dark:border-tournament-dark-border dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-tournament-dark-muted cursor-pointer"
