...
export const RoundProgressBar = ({
  ...
  return (
    <div className="flex items-center gap-2 w-full justify-between md:justify-normal">
      <div className="flex-1 min-w-0 md:flex-none md:w-1/3 lg:w-1/4 h-2 bg-slate-200 dark:bg-tournament-dark-muted rounded-full overflow-hidden">
        <div
      ...
      <span className="text-sm text-slate-600 dark:text-slate-300 text-right md:text-start whitespace-nowrap md:whitespace-normal shrink-0 md:shrink">
